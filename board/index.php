		...
		<section class="add__section">
			...
			<form method="POST" action="addPost.php">
				<div class="add__comment">
					...
					<div><input name="nickname" placeholder="請輸入你的暱稱.." required/></div>
					<div class="desc"> 有什麼想說的嗎? </div>
					<div><textarea name="content" rows="8" placeholder="請輸入你的留言.." required></textarea></div>
				</div>
				<div class="add__btn"><button>送出</button>	
			</form>		
		</section>
					...
					<div class='comment'>
						...
						<div class='comment__details'>
							<div class='first__row'>
								...
								<a href='./editComment.php' class='edit__btn' title='edit'></a>
								<a href='./deleteComment.php' class='delete__btn' title='delete'></a>
							</div>
